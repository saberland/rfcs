...
through a bit of a design process and produce a consensus among the Saber
...
[Pending RFC List](https://github.com/saberland/rfcs/pulls)

## When to follow this process

You need to follow this process if you intend to make "substantial"
changes to Saber or its documentation.
...
- The introduction of new idiomatic usage or conventions, even if they do not include code changes to Saber itself.
...
- Additions only likely to be _noticed by_ other implementors-of-Saber, invisible to users-of-Saber.
...
In short, to get a major feature added to Saber, one must first get the
RFC merged into the RFC repo as a markdown file. At that point the RFC
is 'active' and may be implemented with the goal of eventual inclusion
into Saber.

* Fork the RFC repo http://github.com/saberland/rfcs
...
feature as a pull request to the Saber repo. Becoming 'active' is not a rubber
...
**Saber's RFC process owes its inspiration to the [Vue RFC process].**
